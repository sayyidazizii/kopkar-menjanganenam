...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>savings-print-savings-monitor">
...
?>	
<?php	echo form_open('savings-print-savings-monitor/filter-savings-account',array('id' => 'myform', 'class' => '')); ?>
	...
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="<?php echo base_url();?>savings-print-savings-monitor" class="btn btn-default btn-sm">
								...
								foreach ($acctsavingsaccount as $key=>$val){									
									echo"
										<tr>			
											...
											<td>
												<a href='".$this->config->item('base_url').'savings-print-savings-monitor/get-list-savings-monitor/'.$val['savings_account_id']."' class='btn default btn-xs blue'>
