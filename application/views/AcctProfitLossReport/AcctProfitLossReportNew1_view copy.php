														...
														foreach ($acctprofitlossreport_top as $key => $val) {
															...
															echo "
																...
																if($val['report_type']	== 2){
																	...
																	if(!empty($val['report_formula']) && !empty($val['report_operator'])){
																		...
																		$total_account_amount_type2	= 0;
																		for($i = 0; $i < count($report_formula); $i++){
																			if($report_operator[$i] == '-'){
																				if($total_account_amount_type2 == 0 ){
																					$total_account_amount_type2 = $total_account_amount_type2 + $account_amount[$report_formula[$i]];
																				} else {
																					$total_account_amount_type2 = $total_account_amount_type2 - $account_amount[$report_formula[$i]];
																				}
																		...
																		echo "
																			...
																			<td style='text-align:right'><div style='font-weight:".$report_bold."'>".number_format($total_account_amount_type2, 2)."</div></td>
																			";
																	}
																	// echo "
															...
															echo "
																...
																if($val['report_type']	== 7){
																	...
																	$account_amount_minus_operation = $account_subtotal;
																}
															echo "
																</tr>";
												...
												<table class="table table-bordered table-advance table-hover">
													<tr>
														...
														<td style="width: 25%; text-align:right" >
															<div style='font-weight:bold; font-size:16px'>
																<?php
																	$shu = $grand_total_account_amount1 - $grand_total_account_amount2 - $account_amount_minus_operation;
