...
<script type="text/javascript">
	...
	function reset_search(){
		document.location = base_url +"savings-cash-mutation-branch/reset-search";
	}
</script>
<div class="row-fluid">
	...
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>savings-cash-mutation-branch">
				Daftar Mutasi Tabungan (Antar Cabang)
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
	</ul>
...
?>	
<?php	echo form_open('savings-cash-mutation-branch/filter',array('id' => 'myform', 'class' => '')); 
	...
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="<?php echo base_url();?>savings-cash-mutation-branch/add" class="btn btn-default btn-sm">
						<i class="fa fa-plus"></i>
						<span class="hidden-480">
							Tambah Mutasi Tabungan Baru
						</span>
					</a>
				</div>
			</div>
...
$(document).ready(function() {
    ...
    table = $('#myDataTable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('savings-cash-mutation-branch/get-savings-cash-mutation-branch')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 
