					...
					<table style="width: 100%;" border="0" padding:"0">
							<tbody>
								<tr>
									<td>Pola Angsuran</td>
									<td>:</td>
									<td><?php $urlagunan=base_url().'AcctCreditAccountUtility/angsuran/'.$acctcreditsaccount['credits_account_id'];?><button type="button" class="btn btn-info btn-sm" onclick="popuplink('<?php echo $urlagunan; ?>');">Pola Angsuran</button>
									</td>
									<td></td>
									<td></td>
									<td></td>
						...
						<div class="row">
							<div class="col-md-12" style='text-align:right'>
								<a href="<?php echo base_url().'AcctCreditAccountUtility/printNoteAcctCreditAccountUtility/'.$acctcreditsaccount['credits_account_id']; ?>" class="btn green-jungle"><i class="fa fa-print"></i> Cetak Kwitansi</a>
								<a href="<?php echo base_url().'AcctCreditAccountUtility/addform'; ?>" class="btn green-jungle">New</a>
							</div>	
						</div>
	...
	<div class="col-md-12">
		<div class="portlet box blue">
			...
			<div class="portlet-body">
				...
				<!-- 	<div class="row">
					<div class="col-md-5">
					<?php echo form_open('AcctCreditAccountUtility/cekPolaANgsuran',array('id' => 'myform', 'class' => 'horizontal-form')); ?>
					<table width="50%">
					...
					<?php echo form_open('AcctCreditAccountUtility/printPolaAngsuran',array('id' => 'myform', 'class' => 'horizontal-form')); ?>
					<input type="hidden" class="easyui-textbox" name="id_credit" value="<?php echo $this->uri->segment(3); ?>">
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
      		<?php $this->load->view('AcctCreditAccountUtility/FormShowCreditAgunan'); ?>
      </div>
