...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctCreditAccountUtility">
				Daftar Pembiayaan
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
...
?>	
<?php	echo form_open('AcctCreditAccountUtility/filteracctcreditsaccount',array('id' => 'myform', 'class' => '')); 
	...
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="<?php echo base_url();?>AcctCreditAccountUtility/addform" class="btn btn-default btn-sm">
...
$(document).ready(function() {
    ...
    table = $('#myDataTable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('AcctCreditAccountUtility/getAcctCreditsAccountList')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 
