...
<script type="text/javascript">
	...
	function reset_search(){
		document.location = base_url+"savings-print-mutation/reset-book";
	}
</script>
<div class="row-fluid">
...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>savings-print-mutation">
				Cetak Cover Buku
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
...
?>	
<?php	echo form_open('savings-print-mutation/filter-book',array('id' => 'myform', 'class' => '')); 
?>
<div class="row">
	<div class="col-md-12">
