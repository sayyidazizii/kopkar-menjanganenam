...
<?php echo form_open('edituser/processEditUser',array('id' => 'myform', 'class' => 'horizontal-form')); ?>
	<?php
		...
		<div class="col-md-12">
			<div class="portlet"> 
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-shopping-cart"></i>Edit Password
					</div>
				</div>
			</div>
		</div>
						...
						<div class="form-body">
							<div class="form-group">
									...
									*
									...
									<input type="text" readonly name="last_username" class="form-control" id="last_username" value="<?php echo $result['username'];?>"/>
							</div>
							<div class="form-group">
								<label class="control-label">Old Password</label>
								<input type="password" name="opassword" class="form-control" id="opassword" name="opassword" placeholder="Admin" value="<?php echo set_value('opassword',$data['opassword']);?>"/>
							</div>
							<div class="form-group">
