...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>credits-account-officer-report">
				Daftar Nasabah Pinjaman Per BO
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
	</ul>
		...
		<div class="portlet box blue">
			...
			<div class="portlet-body">
				<div class="form-body">
					...
					<?php	echo form_open('credits-account-officer-report/viewreport',array('id' => 'myform', 'class' => ''));  
