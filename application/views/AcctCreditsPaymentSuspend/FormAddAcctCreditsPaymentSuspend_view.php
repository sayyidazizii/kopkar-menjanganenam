...
<script>
	...
	function duedatecalc(data){
		...
		if(angsuran == 1){
			...
			var month2 		= date_first.substring(5, 7);
			var year2 		= date_first.substring(0, 4); 
			var first 		= day + '-' + month + '-' + year;


		

			$('#credits_payment_date_new').textbox('setValue',first);
		}
...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>credits-payment-suspend/add-cash-payment">
		...
		<div class="portlet"> 
			 <div class="portlet box blue">
				<div class="portlet-title">
					...
					<div class="actions">
						<a href="<?php echo base_url();?>credits-payment-suspend" class="btn btn-default btn-sm">
...
$(document).ready(function() {
    ...
    table = $('#akadtable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('credits-payment-suspend/akad-list-tunai')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 
