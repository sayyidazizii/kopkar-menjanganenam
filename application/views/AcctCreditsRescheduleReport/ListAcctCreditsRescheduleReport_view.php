...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>credits-reschedule-report">
				Daftar Reschedulling Pinjaman
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
	</ul>
...
<h3 class="page-title">
	Daftar Reschedulling Pinjaman<small> Kelola Daftar Reschedulling Pinjaman</small>
</h3>
<?php
...
?>	
<?php	echo form_open('credits-reschedule-report/viewreport',array('id' => 'myform', 'class' => '')); 
?>
<div class="row">
	<div class="col-md-12">
