...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>help-book-insurance">
				Daftar Buku Pembantu - Hutang Asuransi Pinjaman
			</a>
		</li>
	</ul>
</div>
...
?>	
<?php	echo form_open('help-book-insurance/viewreport',array('id' => 'myform', 'class' => '')); ?>
<div class="row">
	<div class="col-md-12">
