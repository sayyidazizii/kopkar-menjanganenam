										...
										echo"
											<tr>			
												...
												<td>
													...
													<a href='".$this->config->item('base_url').'branch/delete/'.$val['branch_id']."'class='btn default btn-xs red', onClick='javascript:return confirm(\"apakah yakin ingin dihapus ?\")'>
