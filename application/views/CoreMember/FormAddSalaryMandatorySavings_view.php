							...
							<div class="col-md-12">
											...
											foreach ($coremember as $key=>$val){ 
												echo"
													<tr>
														...
														<td style='text-align:right'>".number_format($val['member_mandatory_savings'], 2)."</td>
													</tr>
												";
												$no++;
												$mandatory_savings_total_amount += $val['member_mandatory_savings'];
											}
										} ?>
									</tbody>
								</table>
								...
								<table width="40%" align="right">
									...
									<tr>
										...
										<td width="5%"></td>
										<td width="60%">
											<input type="text" class="easyui-textbox" name="member_mandatory_savings_view" id="member_mandatory_savings_view" value="<?php echo number_format($mandatory_savings_total_amount, 2) ?>" autocomplete="off" style="width: 100%" readonly/>
											<input type="hidden" class="easyui-textbox" name="member_mandatory_savings" id="member_mandatory_savings" value="<?php echo $mandatory_savings_total_amount ?>"  autocomplete="off" />
										</td>
									</tr>
									<tr>
