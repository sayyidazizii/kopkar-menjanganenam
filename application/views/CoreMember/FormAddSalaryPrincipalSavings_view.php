...
<?php echo form_open('member/process-add-salary-principal',array('id' => 'myform', 'class' => 'horizontal-form')); 
...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>member/salary-principal-savings/"<?php echo $coremember['member_id'] ?>>
				Tambah Simpanan Pokok Potong Gaji 
			</a>
		</li>
	</ul>
</div>
		...
		<div class="portlet"> 
			<div class="portlet box blue">
				<div class="portlet-title">
					<div class="caption">
						Form Simpanan Pokok Potong Gaji
					</div>
					<div class="actions">
							...
							<div class="col-md-5">
								...
								<table>
									<tr>
										...
										<td width="5%"></td>
										<td width="60%">
											<?php echo form_dropdown('mutation_id', $acctmutation, set_value('mutation_id', 14),'id="mutation_id" class="easyui-combobox" style="width:100%" readonly');?>
...
$(document).ready(function() {
    ...
    table = $('#myDataTable').DataTable({ 
        ...
        "order": [],
        "ajax": {
            "url": "<?php echo site_url('member/get-list-salary-principal')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 
