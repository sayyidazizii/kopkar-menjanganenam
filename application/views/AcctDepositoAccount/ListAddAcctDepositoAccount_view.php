...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>deposito-account/list">
...
?>	
<?php	echo form_open('deposito-account/filter-list-deposito-account',array('id' => 'myform', 'class' => '')); 
								...
								foreach ($acctdepositoaccount as $key=>$val){									
									echo"
										<tr>			
											...
											<td>
												<a href='".$this->config->item('base_url').'deposito-account/add-new-deposito-account/'.$val['deposito_account_id']."' class='btn default btn-xs blue'>
