								...
								<table width="100%">
									...
									<tr>
									 ...
									 <tr>
										...
										<td>:</td> 
										<td>
											<input type="text" class="easyui-textbox" name="sisa_pokok_view" id="sisa_pokok_view" value="<?php echo number_format($accountcredit['credits_account_last_balance']);?>" readonly/>
