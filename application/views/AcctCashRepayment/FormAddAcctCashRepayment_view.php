...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctCashRepayments/addAcctCashRepayment">
...
<?php echo form_open('AcctCashRepayments/processAddAcctCashRepayment',array('id' => 'myform', 'class' => 'horizontal-form')); ?>
<?php
	$sesi 			= $this->session->userdata('unique');
	$data 			= $this->session->userdata('addAcctCashRepayment-'.$sesi['unique']);
		...
		<div class="portlet"> 
			 <div class="portlet box blue">
				<div class="portlet-title">
					...
					<div class="actions">
						<a href="<?php echo base_url();?>AcctCashRepayments" class="btn btn-default btn-sm">
...
$(document).ready(function() {
    ...
    table = $('#akadtable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('AcctCashRepayments/akadlisttunai')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 
