...
<?php echo form_open('AcctCashLessRepayments/AcctCashLessRepaymentsProcess',array('id' => 'myform', 'class' => 'horizontal-form')); ?>
...
?>
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctCashLessRepayments/addCashlessPayment/">
		...
		<div class="portlet"> 
			<div class="portlet box blue">
				<div class="portlet-title">
					...
					<div class="actions">
						<a href="<?php echo base_url();?>AcctCashLessRepayments" class="btn btn-default btn-sm">
						...
						<div class="row">
							...
							<div class="col-md-5">
								<table width="100%">
									...
									<tr>
										<td width="35%">Tanggal Pembayaran<span class="required">*</span></td>
										<td width="5%"></td>
									...
									<tr>
										<td width="35%">Pembayaran Ke</span></td>
										<td width="5%"></td>
							...
							<div class="col-md-5">
								<table>
									...
									<tr>
										<td width="35%">Pembayaran Pokok (Rp)<span class="required">*</span></td>
										<td width="5%"></td>
										<td width="60%">
									...
									<tr>
										<td width="35%">Pembayaran Bunga (Rp)<span class="required">*</span></td>
										<td width="5%"></td>
										<td width="60%">
											...
											<input type="hidden" class="easyui-textbox" name="sisa_bunga_awal" id="sisa_bunga_awal" value="<?php echo $credit_account['credits_account_interest_last_balance'];?>" readonly/>
										</td>
									</tr>
									<tr>
										<td width="35%">Pembayaran Denda (Rp)<span class="required">*</span></td>
										<td width="5%"></td>
										<td width="60%">
...
$(document).ready(function() {
    ...
    table = $('#akadtable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('AcctCashLessRepayments/akadlist/'.$segement3.'/'.$segement4)?>",
            "type": "POST"
        },
        "columnDefs": [
        { 
	...
	table = $('#simpantable').DataTable({ 
        ...
        "ajax": {
            ...
            "url": "<?php echo site_url('AcctCashLessRepayments/simpananlist/'.$segement3.'/'.$segement4)?>",
            "type": "POST"
        },
        "columnDefs": [
        { 
