...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>help-book-employee">
				Daftar Buku Pembantu - Uang Muka Karyawan
			</a>
		</li>
	</ul>
</div>
...
?>	
<?php	echo form_open('help-book-employee/viewreport',array('id' => 'myform', 'class' => '')); ?>
<div class="row">
	<div class="col-md-12">
