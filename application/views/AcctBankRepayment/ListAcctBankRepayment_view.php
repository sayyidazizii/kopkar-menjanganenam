...
<script type="text/javascript">
	...
	function reset_search(){
		document.location = base_url +"AcctBankRepayments/reset";
	}
</script>
<div class="row-fluid">
...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctBankRepayments">
				Daftar Angsuran via Bank
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
	</ul>
...
?>	
<?php	echo form_open('AcctBankRepayments/filterAcctBankRepayment',array('id' => 'myform', 'class' => '')); 
	...
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="<?php echo base_url();?>AcctBankRepayments/addAcctBankRepayment" class="btn btn-default btn-sm">
						<i class="fa fa-plus"></i>
						<span class="hidden-480">
							Tambah Angsuran via Bank Baru
						</span>
					</a>
				</div>
			</div>
...
$(document).ready(function() {
    ...
    table = $('#myDataTable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('AcctBankRepayments/getAcctBankRepayment')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 
