...
?>	
<?php	echo form_open('AcctSavingsMutation/filter',array('id' => 'myform', 'class' => '')); 
	...
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="<?php echo base_url();?>AcctSavingsMutation/addAcctSavingsMutation" class="btn btn-default btn-sm">
								...
								foreach ($acctsavingsmutation as $key=>$val){									
									echo"
										<tr>			
											...
											<td>".tgltoview($val['savings_mutation_date'])."</td>
											<td>".$val['mutation_name']."</td>
											<td>".number_format($val['savings_mutation_amount'])."</td>
											<td>
												<a href='".$this->config->item('base_url').'AcctSavingsMutation/editAcctSavingsMutation/'.$val['savings_mutation_id']."' class='btn default btn-xs purple'>
													<i class='fa fa-edit'></i> Edit
												</a>
												<a href='".$this->config->item('base_url').'AcctSavingsMutation/deleteAcctSavingsMutation/'.$val['savings_mutation_id']."'class='btn default btn-xs red', onClick='javascript:return confirm(\"apakah yakin ingin dihapus ?\")'>
