...
<script type="text/javascript">
	...
	function reset_search(){
		document.location = base_url +"credits-payment-suspend/reset";
	}
</script>
<div class="row-fluid">
...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctCreditsPaymentSuspend">
				Penundaan Angsuran
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
...
?>	
<?php	echo form_open('credits-payment-suspend/filter',array('id' => 'myform', 'class' => '')); 
	...
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption">
					Daftar Penundaan Angsuran
				</div>
				<!-- <div class="tools">
					<a href="javascript:;" class='expand'></a>
				</div> -->
				<div class="actions">
					<a href="<?php echo base_url();?>credits-payment-suspend/add" class="btn btn-default btn-sm">
						<i class="fa fa-plus"></i>
						<span class="hidden-480">
							Tambah Penundaan Angsuran Baru
						</span>
					</a>
				</div>
			</div>
				...
				<div class="form-body">
					...
					<thead>
						<tr>
							...
							<th width="10%">Penundaan Angsuran</th>
							<th width="10%">Tanggal Angsuran Lama</th>
							<th width="10%">Tanggal Angsuran Baru</th>
						</tr>
					</thead>
					<tbody></tbody>
					</table>
...
$(document).ready(function() {
    ...
    table = $('#myDataTable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('credits-payment-suspend/get-credits-payment-suspend')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 
