...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctBalanceSheetComparationReportNew">
...
<?php
	...
	$data 		= $this->session->userdata('filter-AcctBalanceSheetComparationReportNew');
	$year_now 	= date('Y');
...
<?php echo form_open('AcctBalanceSheetComparationReportNew/filter',array('id' => 'myform', 'class' => '')); ?>
<div class="row">
	<div class="col-md-12">	
		...
		<div class="portlet box blue">
			<div class="portlet-body">
				...
				<div class="form-body form">
						...
						<br>
						<?php
							echo form_open('AcctBalanceSheetComparationReportNew/processPrinting'); 
							...
							$minus_month1	= mktime(0, 0, 0, date($month_now) );
							$month1	 = date('m', $minus_month1);
							...
							$minus_month	= mktime(0, 0, 0, date($month1) - 1);
							$month_before	= date('m', $minus_month);

							$minus_month1	= mktime(0, 0, 0, date($month_now) - 1);
							$month_before1	= date('m', $minus_month1);
												...
												foreach ($acctbalancesheetcomparationreport_left as $key => $val) {
													...
													echo "
														...
														if($val['report_type1']	== 3){
															$last_balance1 = $this->AcctBalanceSheetComparationReportNew_model->getOpeningBalance($val['account_id1'], $month_before, $year_before, $data['account_comparation_report_type'], $data['branch_id']);

															if(empty($last_balance1)){
																$last_balance1 = $this->AcctBalanceSheetComparationReportNew_model->getOpeningBalance2($val['account_id1'], $month_before, $year_before, $data['account_comparation_report_type'], $data['branch_id']);
															}
													...
													echo "
														...
														if($val['report_type1']	== 10){
															$last_balance10 = $this->AcctBalanceSheetComparationReportNew_model->getOpeningBalance($val['account_id1'], $month_before, $year_before, $data['account_comparation_report_type'], $data['branch_id']);

															if(empty($last_balance10)){
																$last_balance10 = $this->AcctBalanceSheetComparationReportNew_model->getOpeningBalance2($val['account_id1'], $month_before, $year_before, $data['account_comparation_report_type'], $data['branch_id']);
															}

															$account_amount10_before[$val['report_no']] = $last_balance10;
														}
																...
																for($i = 0; $i < count($report_formula1); $i++){
																	if($report_operator1[$i] == '-'){
																		if($grand_total_account_amount2 == 0 ){
																			$grand_total_account_amount2 = $total_account_amount10 + $account_amount10_before[$report_formula1[$i]];
																		} else {
																			$total_account_amount10 = $total_account_amount10 - $account_amount10_before[$report_formula1[$i]];
																		}
												...
												foreach ($acctbalancesheetcomparationreport_right as $key => $val) {
													...
													echo "
														...
														if($val['report_type2']	== 3){
															$last_balance2 = $this->AcctBalanceSheetComparationReportNew_model->getLastBalance($val['account_id2'], $month_before, $year_before, $data['account_comparation_report_type'], $data['branch_id']);
											...
											<?php
												foreach ($acctbalancesheetcomparationreport_left as $key => $val) {
													...
													echo "
														...
														if($val['report_type1']	== 3){
															$last_balance1 = $this->AcctBalanceSheetComparationReportNew_model->getLastBalance($val['account_id1'], $month1, $year_now, $data['account_comparation_report_type'], $data['branch_id']);
													...
													echo "
														...
														if($val['report_type1']	== 10){
															$last_balance10 = $this->AcctBalanceSheetComparationReportNew_model->getLastBalance($val['account_id1'], $month1, $year_now, $data['account_comparation_report_type'], $data['branch_id']);

															if(empty($last_balance10)){
																$last_balance10 = $this->AcctBalanceSheetComparationReportNew_model->getLastBalance($val['account_id1'], $month1, $year_now, $data['account_comparation_report_type'], $data['branch_id']);
															}

															$account_amount10_now[$val['report_no']] = $last_balance10;
														}
											...
											<?php
												foreach ($acctbalancesheetcomparationreport_right as $key => $val) {
													...
													echo "
														...
														if($val['report_type2']	== 3){
															$last_balance2 = $this->AcctBalanceSheetComparationReportNew_model->getLastBalance($val['account_id2'], $month1, $year_now, $data['account_comparation_report_type'], $data['branch_id']);
											...
											<tr>
												<?php
													echo "
														...
														<td style=\"width: 28%; text-align:right;\"><div style=\"font-weight:".$report_bold1."; font-size:14px\">".number_format($total_account_amount1_before+$total_account_amount10_before, 2)."</div>
														</td>
													";
												?>
											</tr>
											...
											<tr>
												<?php 
													echo "
														...
														<td style=\"width: 28%; text-align:right;\"><div style=\"font-weight:".$report_bold2."; font-size:14px\">".number_format($total_account_amount2_before, 2)."</div></td>
													";
												?>
											</tr>
										</table>
											...
											<tr>
												<?php
													echo "
														...
														<td style=\"width: 28%; text-align:right;\"><div style=\"font-weight:".$report_bold1."; font-size:14px\">".number_format($total_account_amount1+$total_account_amount10, 2)."</div>
														</td>
													";
												?>
											</tr>
					...
					<div class="row">
						<div class="col-md-12 " style="text-align  : right !important;">
							...
							<a href='javascript:void(window.open("<?php echo base_url(); ?>AcctBalanceSheetComparationReportNew/exportAcctBalanceSheetComparationReportNew","_blank","top=100,left=200,width=300,height=300"));' title="Export to Excel" class="btn blue"><i class="fa fa-print"></i> Export Data  </a>
