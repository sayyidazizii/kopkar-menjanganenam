													...
													echo "
														...
														if($val['report_type1']	== 3){
															...
															if(empty($last_balance1)){
																$last_balance1 = $this->AcctBalanceSheetComparationReport_model->getLastBalance2($val['account_id1'], $month_before, $year_before, $data['account_comparation_report_type'], $data['branch_id']);
															}
													...
													echo "
														...
														if($val['report_type2']	== 3){
															...
															if(empty($last_balance2)){
																$last_balance2 = $this->AcctBalanceSheetComparationReport_model->getLastBalance2($val['account_id2'], $month_before, $year_before, $data['account_comparation_report_type'], $data['branch_id']);
															}
												...
												foreach ($acctbalancesheetcomparationreport_left as $key => $val) {
													...
													echo "
														...
														if($val['report_type1']	== 3){
															...
															if(empty($last_balance1)){
																$last_balance1 = $this->AcctBalanceSheetComparationReport_model->getLastBalance2($val['account_id1'], $month_now, $year_now, $data['account_comparation_report_type'], $data['branch_id']);
															}
												...
												foreach ($acctbalancesheetcomparationreport_right as $key => $val) {
													...
													echo "
														...
														if($val['report_type2']	== 3){
															...
															if(empty($last_balance2)){
																$last_balance2 = $this->AcctBalanceSheetComparationReport_model->getLastBalance2($val['account_id2'], $month_now, $year_now, $data['account_comparation_report_type'], $data['branch_id']);
															}
