...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctJournalPPOB">
				Daftar Jurnal PPOB
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
...
?>	
<?php	echo form_open('AcctJournalPPOB/filter',array('id' => 'myform', 'class' => '')); 
					...
					<tbody>
						<?php
							...
							if(empty($AcctJournalPPOB)){
								...
								foreach ($AcctJournalPPOB as $key=>$val){
									$id = $this->AcctJournalPPOB_model->getMinID($val['journal_voucher_id']);
