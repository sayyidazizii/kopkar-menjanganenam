...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>financial-analysis-ratio-report">
				Daftar Laporan Analisa Rasio Keuangan
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
	</ul>
...
?>	
<?php	echo form_open('financial-analysis-ratio-report/viewreport',array('id' => 'myform', 'class' => '')); ?>
<div class="row">
	<div class="col-md-12">
				...
				<div class="form-body form">
					 <div class = "row">
						...
						<div class="col-md-4">
							<div class="form-group form-md-line-input">
								<?php
									echo form_dropdown('month_id', $month, set_value('month_id', date('m')),'id="month_id" class="form-control select2me" ');
								?>
								<label>Bulan</label>
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group form-md-line-input">
								<?php
									echo form_dropdown('year_id', $year, set_value('year_id', date('Y')),'id="year_id" class="form-control select2me" ');
								?>
								<label>Tahun</label>
							</div>
						</div>
