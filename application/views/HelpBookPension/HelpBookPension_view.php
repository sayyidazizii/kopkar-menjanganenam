...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>help-book-pension">
				Daftar Buku Pembantu - Hutang Dana Pensiun
			</a>
		</li>
	</ul>
</div>
...
?>	
<?php	echo form_open('help-book-pension/viewreport',array('id' => 'myform', 'class' => '')); ?>
<div class="row">
	<div class="col-md-12">
