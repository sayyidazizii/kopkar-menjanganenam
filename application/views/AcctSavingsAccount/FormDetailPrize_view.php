						...
						<div class="col-md-5">
							<table style="width: 100%;" border="0" padding="0">
								...
								<tr>
									...
									<td width="5%"> : </td>
									<td width="60%">
										<input name="savings_account_prize_name" id="savings_account_prize_name" type="text" class="easyui-textbox" value="<?php echo $acctsavingsaccount['savings_account_prize_name']; ?>" style="width: 100%" readonly>
									</td>
								</tr>
								<tr>
									...
									<td width="5%"> : </td>
									<td width="60%">
										<input name="savings_account_prize_amount" id="savings_account_prize_amount" type="text" class="easyui-textbox" value="<?php echo number_format($acctsavingsaccount['savings_account_prize_amount'], 2); ?>" style="width: 100%" readonly>
									</td>
								</tr>
							</table>
						</div>
