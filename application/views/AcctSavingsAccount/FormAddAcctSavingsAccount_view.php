	...
	$(document).ready(function(){
		$('#savings_id').combobox({
			onChange: function(value){
				...
				if(value == 35){
					$('#mutation_preference_id').combobox('setValue', 2);
					$('#mutation_preference_id').combobox('readonly', true);
					$('#savings_interest_rate').textbox('readonly', false);
				}else{
					$('#mutation_preference_id').combobox('setValue', 1);
					$('#mutation_preference_id').combobox('readonly', false);
					$('#savings_interest_rate').textbox('readonly', true);
				}
...
<?php }
	if(!empty($membersavingsaccount)){
?>
<div class='alert alert-danger alert-dismissable'>
	<button type='button' class='close' data-dismiss='alert' aria-hidden='true'></button>					
		Anggota Sudah Memiliki Tabungan
</div>
<?php } ?>
<div class="row">
	<div class="col-md-12">
						...
						<div class="row">
							...
							<div class="col-md-5">
								<table width="100%">
									...
									<tr>
										<td width="35%">Jenis Tabungan <span class="required" style="color : red">*</span></td>
										<td width="5%">:</td>
									...
									<tr>
										<td width="35%">Preferensi Mutasi <span class="required" style="color : red">*</span></td>
										<td width="5%">:</td>
										<td width="60%"><?php echo form_dropdown('mutation_preference_id', $mutationpreference, set_value('mutation_preference_id',$data['mutation_preference_id']),'id="mutation_preference_id" class="easyui-combobox" style="width: 100%"');?></td>
									</tr>
									<tr>
									...
									<tr>
										<td width="35%">Bunga (%) Per Bulan</td>
										<td width="5%">:</td>
									...
									<tr>
										<td width="35%">Business Officer (BO) <span class="required" style="color : red">*</span></td>
										<td width="5%">:</td>
									...
									<tr>
										<td width="35%">Setoran (Rp) <span class="required" style="color : red">*</span></td>
										<td width="5%">:</td>
									...
									<tr>
										...
										<?php if($coremember['member_active_status'] == 1){ ?>
											<button type="submit" name="Save" id="Save" class="btn green-jungle" disabled><i class="fa fa-check"></i> Simpan</button>
										<?php } else{ ?> 
