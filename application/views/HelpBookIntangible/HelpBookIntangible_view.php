...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>help-book-intangible">
				Daftar Buku Pembantu - Aset Tidak Berwujud
			</a>
		</li>
	</ul>
</div>
...
?>	
<?php	echo form_open('help-book-intangible/viewreport',array('id' => 'myform', 'class' => '')); ?>
<div class="row">
	<div class="col-md-12">
