...
<h3 class="page-title">
	Daftar Cetak Slip Potong Gaji Temporary <small>Kelola Cetak Slip Potong Gaji Temporary</small>
</h3>
<?php
...
?>	
<?php	echo form_open('debt-member-print-temp/viewreport',array('id' => 'myform', 'class' => '')); ?>
<div class="row">
	<div class="col-md-12">
