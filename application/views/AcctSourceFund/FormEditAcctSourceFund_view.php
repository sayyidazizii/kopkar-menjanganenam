...
<?php echo form_open('source-fund/process-edit',array('id' => 'myform', 'class' => 'horizontal-form')); ?>
...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>source-fund">
				Daftar Sumber Dana
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
		<li>
			<a href="<?php echo base_url();?>source-fund/edit/"<?php $this->uri->segment(3); ?>>
				Edit Sumber Dana 
			</a>
		</li>
	</ul>
