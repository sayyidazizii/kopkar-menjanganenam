...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>nominative-savings-report-pickup">
				Daftar Laporan Pickup
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
	</ul>
...
?>	
<?php	echo form_open('nominative-savings-report-pickup/viewreport',array('id' => 'myform', 'class' => '')); ?>
<div class="row">
	<div class="col-md-12">
				...
				<div class="form-body form">
					 <div class = "row">
						...
						<div class="col-md-4">
							<div class="form-group form-md-line-input">
								<?php
									echo form_dropdown('kelompok_laporan_simpanan', $kelompoklaporansimpanan,set_value('kelompok_laporan_simpanan'),'id="kelompok_laporan_simpanan" class="form-control select2me"');
								?>
