...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>help-book-jamsostek">
				Daftar Buku Pembantu - Hutang Jamsostek
			</a>
		</li>
	</ul>
</div>
...
?>	
<?php	echo form_open('help-book-jamsostek/viewreport',array('id' => 'myform', 'class' => '')); ?>
<div class="row">
	<div class="col-md-12">
