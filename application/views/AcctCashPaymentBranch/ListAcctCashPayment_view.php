...
<script type="text/javascript">
	...
	function reset_search(){
		document.location = base_url +"cash-payments-branch/reset-search";
	}
</script>
<div class="row-fluid">
...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>cash-payments-branch/ind-cash-payment">
...
?>	
<?php	echo form_open('cash-payments-branch/filter-cash-payment',array('id' => 'myform', 'class' => '')); 
	...
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="<?php echo base_url();?>cash-payments-branch/add-cash-payment" class="btn btn-default btn-sm">
...
$(document).ready(function() {
    ...
    table = $('#myDataTable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('cash-payments-branch/get-cash-payment')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 
