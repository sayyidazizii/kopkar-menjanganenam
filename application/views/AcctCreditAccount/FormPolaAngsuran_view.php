...
<?php
	...
	$member_address = $creditaccount['member_address']." ".$creditaccount['kecamatan_name']." ".$creditaccount['city_name']." ".$creditaccount['province_name'];
						...
						<div class="col-md-5">
							<table style="width: 100%;" border="0" padding="0">
								<tr>
									...
									<td width="5%"> : </td>
									<td width="60%">
										<input class="easyui-textbox" type="text" name="credits_account_serial" readonly id="credits_account_serial" value="<?php echo $creditaccount['credits_account_serial']; ?>" style="width: 100%"/>
									</td>
								</tr>
								<tr>
									...
									<td width="5%"> : </td>
									<td width="60%">
										<input class="easyui-textbox" type="text" name="member_name" readonly id="member_name" value="<?php echo $creditaccount['member_name']; ?>" style="width: 100%"/>
