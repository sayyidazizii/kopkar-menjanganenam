												...
												foreach ($acctbalancesheetreport_left as $key => $val) {
													...
													echo "
														...
														if($val['report_type1']	== 3){
															$last_balance1 = $this->AcctConsolidationReport_model->getLastBalance($val['account_id1'], $data['consolidation_report'], $data['branch_id']);
												...
												foreach ($acctbalancesheetreport_right as $key => $val) {
													...
													echo "
														...
														if($val['report_type2']	== 3){
															$last_balance2 = $this->AcctConsolidationReport_model->getLastBalance($val['account_id2'], $data['consolidation_report'], $data['branch_id']);
