														...
														foreach ($acctprofitlossreport_top as $key => $val) {
															...
															echo "
																...
																if($val['report_type']	== 3){
																	$accountamount 		= $this->AcctConsolidationReport_model->getAccountAmount($val['account_id'], $data['month_period'], $data['year_period'], $data['consolidation_report'], $data['branch_id']);
