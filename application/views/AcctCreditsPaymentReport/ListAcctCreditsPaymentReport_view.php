...
<h3 class="page-title">
	Daftar Tagihan Pinjaman<small> Kelola Daftar Tagihan Pinjaman</small>
</h3>
<?php
...
?>	
<?php	echo form_open('credits-payment-report/viewreport',array('id' => 'myform', 'class' => '')); 
?>
<div class="row">
	<div class="col-md-12">
				...
				<div class="form-body form">
					 <div class = "row">
						...
						<div class="col-md-3">
							<div class="form-group form-md-line-input">
								<?php
									echo form_dropdown('office_id', $coreoffice,set_value('office_id'),'id="office_id" class="form-control select2me"');
								?>
								<label>BO</label>
							</div>
						</div>
