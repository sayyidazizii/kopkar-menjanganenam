...
<script type="text/javascript">
	$(document).ready(function(){
        $("#city_id").change(function(){
            ...
            $.ajax({
               type : "POST",
               url  : "<?php echo base_url(); ?>savings-account/get-kecamatan",
...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>savings-account/get-list-member">
				Data Anggota
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
...
?>	
<?php	echo form_open('savings-account/filter-list-member',array('id' => 'myform', 'class' => '')); ?>
								...
								foreach ($coremember as $key=>$val){									
									echo"
										<tr>			
											...
											<td>
												<a href='".$this->config->item('base_url').'savings-account/add/'.$val['member_id']."' class='btn default btn-xs blue'>
