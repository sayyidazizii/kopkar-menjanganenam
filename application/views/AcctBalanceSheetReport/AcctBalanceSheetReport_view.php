												...
												foreach ($acctbalancesheetreport_left as $key => $val) {
													...
													echo "
														...
														if($val['report_type1']	== 3){
															$last_balance1 = $this->AcctBalanceSheetReport_model->getLastBalance($val['account_id1'], $data['branch_id'], $data['month_period'], $data['year_period']);
												...
												foreach ($acctbalancesheetreport_right as $key => $val) {
													...
													echo "
														...
														if($val['report_type2']	== 3){
															$last_balance2 = $this->AcctBalanceSheetReport_model->getLastBalance($val['account_id2'], $data['branch_id'], $data['month_period'], $data['year_period']);
															...
															//print_r($account_amount2_bottom);
														}
													...
													echo "
														...
														if($val['report_type2'] == 9){
															$shu_tahun_lalu = $this->AcctBalanceSheetReport_model->getShuTahunLalu($data['branch_id'], $year);

															// print_r($shu_tahun_lalu);

															if(empty($shu_tahun_lalu)){
																$shu_tahun_lalu	= 0;
															}

															echo "
																<td><div style='font-weight:".$report_bold2."'>".$report_tab2."(".$val['account_code2'].") ".$val['account_name2']."</div> </td>
																<td style='text-align:right'><div style='font-weight:".$report_bold2."'>".number_format($shu_tahun_lalu, 2)."</div></td>
																";
														}
													...
													echo "
														...
														if($val['report_type2'] == 6){
															if(!empty($val['report_formula2']) && !empty($val['report_operator2'])){
																...
																$grand_total_account_amount2 += $total_account_amount3 + $shu_tahun_lalu;
															}	
														}
