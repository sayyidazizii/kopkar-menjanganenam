...
<script type="text/javascript">
	...
	function reset_search(){
		document.location = base_url = "savings-salary-mutation/reset-search";
	}
</script>
<div class="row-fluid">
	...
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>savings-salary-mutation">
				Daftar Mutasi Tabungan Potong Gaji
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
	</ul>
...
?>	
<?php	echo form_open('savings-salary-mutation/filter',array('id' => 'myform', 'class' => '')); 
	...
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="<?php echo base_url();?>savings-salary-mutation/add" class="btn btn-default btn-sm">
...
$(document).ready(function() {
    ...
    table = $('#myDataTable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('savings-salary-mutation/get-savings-salary-mutation')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 
