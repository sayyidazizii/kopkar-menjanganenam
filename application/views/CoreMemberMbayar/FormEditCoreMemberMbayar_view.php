...
<?php echo form_open('CoreMemberMbayar/processAddCoreMemberMbayar',array('id' => 'myform', 'class' => 'horizontal-form')); 
?>
...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>CoreMemberMbayar/addCoreMemberMbayar/"<?php echo $this->uri->segment(3) ?>>
		...
		<div class="portlet"> 
			<div class="portlet box blue">
				<div class="portlet-title">
					...
					<div class="actions">
						<a href="<?php echo base_url();?>CoreMemberMbayar" class="btn btn-default btn-sm">
							...
							<div class="col-md-5">
								<table width="100%">
									<tr>
										...
										<td width="5%"></td>
										<td width="60%">
											<input type="text" class="easyui-textbox" name="member_no" id="member_no" autocomplete="off" value="<?php echo set_value('member_no', $coremember['member_no']);?>" style="width: 100%" readonly/>
										</td>
									</tr>
									<tr>
...
$(document).ready(function() {
    ...
    table = $('#myDataTable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('CoreMemberMbayar/getListCoreMemberEdit')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 
...
$(document).ready(function() {
    ...
    var table = $('#myDataTable2').DataTable({ 
        ...
        "order": [], //Initial no order.
        "ajax": {
            "url": "<?php echo site_url('CoreMemberMbayar/getListAcctSavingsAccount/'.$member_id)?>",
            "type": "POST"
        },
        "columnDefs": [
        { 
