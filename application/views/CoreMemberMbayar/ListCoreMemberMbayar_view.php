...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>CoreMemberMbayar">
				Daftar Rekening Mbayar Anggota
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
	</ul>
...
?>	
<?php	echo form_open('CoreMemberMbayar/filter',array('id' => 'myform', 'class' => '')); ?>
<div class="row">
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title">
				...
				<div class="actions">
						<a href="<?php echo base_url();?>CoreMemberMbayar/addCoreMemberMbayar" class="btn btn-default btn-sm">
							<i class="fa fa-plus"></i>
							<span class="hidden-480">
								Input Rekening Mbayar
							</span>
						</a>
					</div>
			</div>
...
$(document).ready(function() {
    ...
    table = $('#myDataTable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('CoreMemberMbayar/getCoreMemberMbayarList')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 
