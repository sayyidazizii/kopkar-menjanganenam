...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctCreditsPaymentSuspendReport">
...
<h3 class="page-title">
	Daftar Penundaan Angsuran<small> Kelola Daftar Penundaan Angsuran</small>
</h3>
<?php
	...
	$sesi = $this->session->userdata('filter-AcctCreditsPaymentSuspendReport');
...
?>	
<?php	echo form_open('AcctCreditsPaymentSuspendReport/viewreport',array('id' => 'myform', 'class' => '')); 
?>
<div class="row">
	<div class="col-md-12">
