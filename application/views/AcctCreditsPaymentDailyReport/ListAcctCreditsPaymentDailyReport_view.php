		...
		<ul class="page-breadcrumb">
			...
			<li>
				<a href="<?php echo base_url();?>credits-payment-report">
					Daftar Angsuran Pinjaman Anggota
				</a>
				<i class="fa fa-angle-right"></i>
			</li>
		</ul>
...
<h3 class="page-title">
	Daftar Angsuran Pinjaman Anggota<small> Kelola Daftar Angsuran Pinjaman Anggota</small>
</h3>
<?php
				...
				<div class="form-body form">
					 <div class = "row">
						...
						<div class="col-md-3">
							<div class="form-group form-md-line-input">
								<?php
									echo form_dropdown('credits_id', $acctcredits, set_value('credits_id'),'id="credits_id" class="form-control select2me" ');
								?>
