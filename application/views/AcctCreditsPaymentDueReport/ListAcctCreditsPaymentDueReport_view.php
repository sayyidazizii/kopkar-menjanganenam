...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>credits-payment-due-report">
...
<h3 class="page-title">
	Daftar Pinjaman Jatuh Tempo<small> Kelola Daftar Pinjaman Jatuh Tempo</small>
</h3>
<?php
...
?>	
<?php	echo form_open('credits-payment-due-report/viewreport',array('id' => 'myform', 'class' => '')); 
?>
<div class="row">
	<div class="col-md-12">
