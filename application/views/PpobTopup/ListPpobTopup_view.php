...
?>	
<?php	echo form_open('PpobTopup/filter',array('id' => 'myform', 'class' => '')); 
	...
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="<?php echo base_url();?>PpobTopup/addPpobTopup" class="btn btn-default btn-sm">
					...
					<table class="table table-striped table-bordered table-hover table-full-width" id="sample_3">
						...
						<tbody>
								<?php
									$no = 1;
									//print_r($PpobTopup);
									if(!is_array($ppobtopup)){
										echo "<tr><th colspan='6' style='text-align  : center !important;'>Data is Empty</th></tr>";
									} else {
										foreach($ppobtopup as $key=>$val){
											echo"
												<tr>
													<td style='text-align: center'></td>				
													<td style='text-align: center'>".$no."</td>				
													<td style='text-align: center'>".$val['branch_name']."</td>
													<td style='text-align: center'>".tgltoview($val['ppob_topup_date'])."</td>
													<td style='text-align: left !important;'>".$val['account_name']."</td>
													<td style='text-align: right !important;'>".nominal($val['ppob_topup_amount'],2)."</td>
													<td style='text-align: left !important;'>".$val['ppob_topup_remark']."</td>
												</tr>
											";
											$no++;
										}
