...
<script>
	...
	function reset_edit(){
		document.location = base_url+"savings-account-blockir/reset-edit/<?php echo $acctsavingsaccountblocker['member_id']?>";
	}
...
<?php echo form_open('savings-account-blockir/process-add-unblockir',array('id' => 'myform', 'class' => 'horizontal-form'));?>
		...
		<div class="portlet"> 
			<div class="portlet box blue">
				<div class="portlet-title">
					...
					<div class="actions">
						<a href="<?php echo base_url();?>savings-account-blockir/unblockir" class="btn btn-default btn-sm">
