...
<script type="text/javascript">
	...
	function reset_search(){
		document.location = base_url +"salary-payments/reset";
	}
</script>
<div class="row-fluid">
...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>salary-payments/ind-salary-payment">
				Daftar Angsuran via Potong Gaji
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
	</ul>
...
?>	
<?php	echo form_open('salary-payments/filter-salary-payment',array('id' => 'myform', 'class' => '')); 
	...
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="<?php echo base_url();?>salary-payments/add" class="btn btn-default btn-sm">
						<i class="fa fa-plus"></i>
						<span class="hidden-480">
							Tambah Angsuran via Potong Gaji Baru
						</span>
					</a>
				</div>
			</div>
...
$(document).ready(function() {
    table = $('#myDataTable').DataTable({ 
        ...
        "order": [],
        "ajax": {
            "url": "<?php echo site_url('salary-payments/get')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 
