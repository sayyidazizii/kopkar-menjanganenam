										...
										if($val['journal_voucher_item_id'] == $id){
											echo"
												<tr>			
													...
													<td style='text-align:center'>".$val['journal_voucher_no']."</td>
													...
													<td style='text-align:center'>
														...
														if($val['repayment_status'] != 2){
															echo "<a href='".$this->config->item('base_url').'journal-voucher/repayment/'.$val['journal_voucher_id']."'class='btn default btn-xs yellow'>
															<i class='fa fa-refresh'></i> Pelunasan
															</a>";
														}
													echo "</td>
												</tr>
