				...
				<div class="portlet-body">
					<div class="form-body">
						<div class="row">						
							...
							<div class="col-md-5">
								<table width="100%">
									<?php if($journal_voucher_id){ ?>
									<tr>
										<td width="35%">Pelunasan Untuk</td>
										<td width="5%">:</td>
										<td width="60%">
											<input class="easyui-textbox" type="text" name="journal_voucher_repayment" id="journal_voucher_repayment" value="<?php echo $journal_voucher_id;?>" readonly/>
										</td>
									</tr>
									<?php } ?>
									<tr>
										...
										<td width="5%">:</td>
										<td width="60%">
											<input class="easyui-datebox" data-options="formatter:myformatter,parser:myparser" type="text" name="journal_voucher_date" id="journal_voucher_date" onChange="function_elements_add(this.name, this.value);" value="<?php echo tgltoview($data['journal_voucher_date']);?>" style="width: 100%"/>
