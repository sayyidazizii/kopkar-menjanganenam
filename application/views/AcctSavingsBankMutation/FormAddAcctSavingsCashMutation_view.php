...
<?php
	...
	$data 	= $this->session->userdata('addAcctSavingsBankMutation-'.$sesi['unique']);
						...
						<div class="row">
							...
							<div class="col-md-5">
								<table width="100%">
									...
									<tr>
										<td width="35%">Jumlah Transaksisss (Rp)</td>
										<td width="5%">:</td>
										<td width="60%">
											<input type="text" class="easyui-textbox" style="width: 100%" name="savings_bank_mutation_amount_view" readonly id="savings_bank_mutation_amount_view" autocomplete="off" value="<?php echo set_value('savings_bank_mutation_amount',$data['savings_bank_mutation_amount'] ?? 'Pilih Sandi Dahulu');?>"/>
