...
<script>
	...
	function calculateSavings(){
		...
		if(adm_method == 3){
			savings_cash_mutation_last_balance -= savings_cash_mutation_amount_adm;
		}
							...
							<div class="col-md-5">
								<table width="100%">
									...
									<tr>
										...
										<td width="5%">:</td>
										<td width="60%">
											<input type="text" class="easyui-textbox" name="savings_cash_mutation_amount_adm_view" id="savings_cash_mutation_amount_adm_view" autocomplete="off" style="width: 100%" value="<?php echo set_value('savings_cash_mutation_amount_adm_view', $data['savings_cash_mutation_amount_adm_view']);?>"/>
											<input type="hidden" class="easyui-textbox" name="savings_cash_mutation_amount_adm" id="savings_cash_mutation_amount_adm" autocomplete="off" value="<?php echo set_value('savings_cash_mutation_amount_adm', $data['savings_cash_mutation_amount_adm']);?>"/>
										</td>
									</tr>
									<tr>
									...
									<tr id="adm_bank_account">
										...
										<td width="5%"> : </td>
										<td width="60%"><?php echo form_dropdown('adm_bank_account_id', $acctbankaccount, set_value('adm_bank_account_id',$data['adm_bank_account_id']),'id="adm_bank_account_id" class="easyui-combobox" style="width:100%" ');?></td>
									</tr>
									<tr>
										<td width="35%">Tanggal Transaksi</td>
										<td width="5%">:</td>
										<td width="60%"><input type="text" class="easyui-textbox" style="width: 100%" name="savings_cash_mutation_date" id="savings_cash_mutation_date" autocomplete="off" value="<?php echo date('d-m-Y'); ?>" readonly/>
										</td>
									</tr>
									<tr>
