					...
					<div class="portlet-body form">
						...
						<div class="form-group">
								...
								*
								...
								<input type="text" name="user_name" class="form-control" id="user_name" onChange="warningusername(user_name);" placeholder="Admin" value="<?php echo $result['user_name'];?>"/>
							</div>
						<div class="form-group">
							...
							<?php
								if($result['status_akses']=='0'){
							?>
							<div class="form-group">
								<label class="control-label">Status User
								<span class="required">
								*
								</span>
								</label>
								...
								<div class="input-group col-md-8">
									...
									<input type="radio" name="status_akses" id ="status_akses_1" value="0"  onclick='show_date(this.value)' checked="checked"/> All &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
									</label>
									<label class="checkbox inline">
									<input type="radio" name="status_akses" id ="status_akses_2" value="1" onclick='show_date(this.value)' /> Factory
									</label>
								</div>
							</div>
							
							<div class="form-group" id="factory_display" style="display:none;">
								<label class="control-label">Factory
								<span class="required">
								*
								</span>
								</label>
							
								<?php echo form_dropdown('factory_id', $factory,set_value('factory_id',$data['factory_id']),'id="factory_id", class="form-control"');?>
							...
							?>
								...
								*
								...
								<div class="input-group col-md-8">
									<label class="checkbox inline">
									<input type="radio" name="status_akses" id ="status_akses_1" value="0"  onclick='show_date(this.value)'/> All &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
									</label>
									<label class="checkbox inline">
									<input type="radio" name="status_akses" id ="status_akses_2" value="1" onclick='show_date(this.value)'  checked="checked" /> Factory
									</label>
								</div>
							</div>
							
							<div class="form-group" id="factory_display" style="display:block;">
								<label class="control-label">Factory
								<span class="required">
								*
								</span>
								...
								<?php echo form_dropdown('factory_id', $factory,set_value('factory_id',$result['factory_id']),'id="factory_id", class="form-control"');?>
