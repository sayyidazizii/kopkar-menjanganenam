...
<script type="text/javascript">
	...
	function reset_search(){
		document.location = base_url = "uniform-sales/reset-search";
	}
</script>
<div class="row-fluid">
...
<?php
	...
	if(!is_array($sesi)){
		...
		$sesi['uniform_sales_id']		= '';
	}
?>	
<?php	echo form_open('uniform-sales/filter',array('id' => 'myform', 'class' => '')); 
	...
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="<?php echo base_url();?>uniform-sales/add" class="btn btn-default btn-sm">
						<i class="fa fa-plus"></i>
						<span class="hidden-480">
							Tambah Penjualan Seragam Baru
						</span>
					</a>
				</div>
			</div>
...
$(document).ready(function() {
    table = $('#myDataTable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('uniform-sales/get-uniform-sales')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 
