...
<script type="text/javascript">
	$(document).ready(function(){
        $("#city_id").change(function(){
            ...
            $.ajax({
               type : "POST",
               url  : "<?php echo base_url(); ?>uniform-sales/get-kecamatan",
...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>uniform-sales/get-list-core-member">
				Data Anggota
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
...
?>	
<?php	echo form_open('uniform-sales/filter-list-saving-account',array('id' => 'myform', 'class' => '')); ?>
								...
								foreach ($acctsavingsaccount as $key=>$val){									
									echo"
										<tr>			
											...
											<td>
												<a href='".$this->config->item('base_url').'uniform-sales/add/'.$val['savings_account_id']."' class='btn default btn-xs blue'>
