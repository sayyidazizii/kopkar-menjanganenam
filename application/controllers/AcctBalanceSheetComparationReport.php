			        			...
			        			foreach ($acctbalancesheetcomparationreport_left as $keyLeft => $valLeft) {
									...
									if($valLeft['report_type1']	== 3){
										...
										if(empty($last_balance1)){
											$last_balance1 = $this->AcctBalanceSheetComparationReport_model->getLastBalance2($valLeft['account_id1'], $month_before, $year_before, $sesi['account_comparation_report_type'], $sesi['branch_id']);
										}	
			        			...
			        			foreach ($acctbalancesheetcomparationreport_right as $keyRight => $valRight) {
									...
									if($valRight['report_type2']	== 3){
										...
										if(empty($last_balance2)){
											$last_balance2 = $this->AcctBalanceSheetComparationReport_model->getLastBalance2($valRight['account_id1'], $month_before, $year_before, $sesi['account_comparation_report_type'], $sesi['branch_id']);
										}	
			        		...
			        		<table id=\"items\" width=\"100%\" cellspacing=\"0\" cellpadding=\"1\" border=\"0\">";
			        			...
			        			foreach ($acctbalancesheetcomparationreport_left as $keyLeft => $valLeft) {
									...
									if($valLeft['report_type1']	== 3){
										...
										if(empty($last_balance1)){
											$last_balance1 = $this->AcctBalanceSheetComparationReport_model->getLastBalance2($valLeft['account_id1'], $month_now, $year_now, $sesi['account_comparation_report_type'], $sesi['branch_id']);	
										}	
			        		...
			        		<table id=\"items\" width=\"100%\" cellspacing=\"0\" cellpadding=\"1\" border=\"0\">";		
			        			...
			        			foreach ($acctbalancesheetcomparationreport_right as $keyRight => $valRight) {
									...
									if($valRight['report_type2']	== 3){
										...
										if(empty($last_balance2)){
											$last_balance2 = $this->AcctBalanceSheetComparationReport_model->getLastBalance2($valRight['account_id2'], $month_now, $year_now, $sesi['account_comparation_report_type'], $sesi['branch_id']);
										}
				...
				foreach($acctbalancesheetcomparationreport_right as $keyRight =>$valRight){
					if(is_numeric($keyRight)){
						...
						if($valRight['report_type2']	== 3){
							...
							if (empty($last_balance2)){
								$last_balance2 = $this->AcctBalanceSheetComparationReport_model->getLastBalance2($valRight['account_id2'], $month_before, $year_before, $sesi['account_comparation_report_type'], $sesi['branch_id']);	
							}
