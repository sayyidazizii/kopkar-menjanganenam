...
<?php
	Class AcctBalanceSheetReport extends CI_Controller{
		...
		public function index(){
			...
			// print_r($this->AcctBalanceSheetReport_model->getShuTahunLalu($sesi['branch_id'], 2020));
			        		...
			        		<table id=\"items\" width=\"100%\" cellspacing=\"1\" cellpadding=\"2\" border=\"0\">";	
			        			...
			        			foreach ($acctbalancesheetreport_left as $keyLeft => $valLeft) {
									...
									if($valLeft['report_type1']	== 2){
										$tblitem_left2 = "
											<tr>
												...
												<td style=\"width: 32%\"><div style=\"font-weight:".$report_bold1."\"></div></td>
											</tr>";
									} else {
										$tblitem_left2 = "";
									}									
									...
									if($valLeft['report_type1']	== 3){
										$last_balance1 = $this->AcctBalanceSheetReport_model->getLastBalance($valLeft['account_id1'], $sesi['branch_id'], $sesi['month_period'], $sesi['year_period']);		

										$tblitem_left3 = "
											<tr>
												<td style=\"width: 68%\"><div style=\"font-weight:".$report_bold1."\">".$report_tab1."(".$valLeft['account_code1'].") ".$valLeft['account_name1']."</div> </td>
												<td style=\"text-align:right;width: 32%\">".number_format($last_balance1, 2)."</td>
											</tr>";
			        		...
			        		<table id=\"items\" width=\"100%\" cellspacing=\"1\" cellpadding=\"2\" border=\"0\">";		
			        			...
			        			foreach ($acctbalancesheetreport_right as $keyRight => $valRight) {
									...
									if($valRight['report_type2'] == 2){
										$tblitem_right2 = "
											<tr>
												...
												<td style=\"width: 32%\"><div style=\"font-weight:".$report_bold2."\"></div></td>
											</tr>";
									} else {
										$tblitem_right2 = "";
									}									
									...
									if($valRight['report_type2']	== 3){
										$last_balance2 = $this->AcctBalanceSheetReport_model->getLastBalance($valRight['account_id2'], $sesi['branch_id'],$sesi['month_period'], $sesi['year_period']);

										$tblitem_right3 = "
											<tr>
												<td style=\"width: 68%\"><div style=\"font-weight:".$report_bold2."\">".$report_tab2."(".$valRight['account_code2'].") ".$valRight['account_name2']."</div> </td>
												<td style=\"text-align:right;width: 32%\">".number_format($last_balance2, 2)."</td>
											</tr>";
									...
									if($valRight['report_type2']	== 9){
										$shu_tahun_lalu = $this->AcctBalanceSheetReport_model->getShuTahunLalu($sesi['branch_id'], $year);

										$tblitem_right9 = "
											<tr>
												<td style=\"width: 68%\"><div style=\"font-weight:".$report_bold2."\">".$report_tab2."(".$valRight['account_code2'].") ".$valRight['account_name2']."</div> </td>
												<td style=\"text-align:right;width: 32%\">".number_format($shu_tahun_lalu, 2)."</td>
											</tr>";
									} else {
										$tblitem_right9 = "";
									}
									...
									if($valRight['report_type2'] == 7){
										...
										$total_account_amount3 = $total_account_amount1_top - ($total_account_amount2_bottom + $shu_tahun_lalu);
									...
									$tblitem_right .= $tblitem_right1.$tblitem_right2.$tblitem_right3.$tblitem_right9.$tblitem_right7.$tblitem_right5;
									...
									if($valRight['report_type2'] == 6){
										if(!empty($valRight['report_formula2']) && !empty($valRight['report_operator2'])){
											...
											$total_account_amount2 += $total_account_amount3 + $shu_tahun_lalu;
										} else {
			    ...
			    <tr>
			    	<td style=\"width: 50%\">
			    		<table id=\"items\" width=\"100%\" cellspacing=\"1\" cellpadding=\"1\" border=\"0\">
			    			<tr>
								<td style=\"width: 70%\"><div style=\"font-weight:".$report_bold1.";font-size:12px\">".$report_tab1."".$valLeft['account_name1']."</div></td>
								<td style=\"width: 30%; text-align:right;\"><div style=\"font-weight:".$report_bold1."; font-size:14px\">".number_format($total_account_amount1, 2)."</div></td>
							</tr>
			    		</table>
			    	</td>
			    	<td style=\"width: 50%\">
			    		<table id=\"items\" width=\"100%\" cellspacing=\"1\" cellpadding=\"1\" border=\"0\">
			    			<tr>
								<td style=\"width: 70%\"><div style=\"font-weight:".$report_bold2.";font-size:12px\">".$report_tab2."".$valRight['account_name2']."</div></td>
								<td style=\"width: 30%; text-align:right;\"><div style=\"font-weight:".$report_bold2."; font-size:14px\">".number_format($total_account_amount2, 2)."</div></td>
							</tr>
			    		</table>
			    	</td>
			    </tr>
		...
		public function exportAcctBalanceSheetReport(){
			...
			//print_r($acctbalancesheetreport_left);exit;
