<?php
	...
	Class AcctUniformSales extends CI_Controller{
		...
		public function processAddAcctUniformSales(){
			...
			$AcctUniformSales_Last		= $this->AcctUniformSales_model->getAcctUniformSales_Last($data['created_id']);
				...
				if($uniform_sales_token->num_rows()==0){
					if($this->AcctUniformSales_model->insertAcctUniformSales($data)){
						...
						$data_journal = array(
							...
							'journal_voucher_title'			=> 'PENJUALAN SERAGAM '.$AcctUniformSales_Last['member_name'],
							'journal_voucher_description'	=> 'PENJUALAN SERAGAM '.$AcctUniformSales_Last['member_name'],
							'journal_voucher_token'			=> $data['uniform_sales_token'],
							'transaction_module_id'			=> $transaction_module_id,
							'transaction_module_code'		=> $transaction_module_code,
							'transaction_journal_id' 		=> $AcctUniformSales_Last['uniform_sales_id'],
							'transaction_journal_no' 		=> $AcctUniformSales_Last['uniform_sales_no'],
							'created_id' 					=> $data['created_id'],
							'created_on' 					=> $data['created_on'],
						);

					
						if($this->AcctSavingsAccount_model->insertAcctJournalVoucher($data_journal)){
							$journal_voucher_id = $this->AcctUniformSales_model->getJournalVoucherID($data['created_id']);
							
							if($data['uniform_sales_payment_type'] == 1){
								// TODO : JOURNAL VOUCHER
								$account_id_default_status = $this->AcctUniformSales_model->getAccountIDDefaultStatus($preferencecompany['account_cash_id']);
								$data_debet = array (
									'journal_voucher_id'			=> $journal_voucher_id,
									'account_id'					=> $preferencecompany['account_cash_id'],
									'journal_voucher_description'	=> $data_journal['journal_voucher_title'],
									'journal_voucher_amount'		=> $data['uniform_sales_price'],
									'journal_voucher_debit_amount'	=> $data['uniform_sales_price'],
									'account_id_default_status'		=> $account_id_default_status,
									'account_id_status'				=> 0,
									'journal_voucher_item_token'	=> $data['uniform_sales_token'].$preferencecompany['account_cash_id'],
									'created_id' 					=> $auth['user_id'],
								);
								$this->AcctUniformSales_model->insertAcctJournalVoucherItem($data_debet);

								$account_id_default_status = $this->AcctUniformSales_model->getAccountIDDefaultStatus($preferencecompany['account_uniform_sales_id']);
								$data_credit =array(
									'journal_voucher_id'			=> $journal_voucher_id,
									'account_id'					=> $preferencecompany['account_uniform_sales_id'],
									'journal_voucher_description'	=> $data_journal['journal_voucher_title'],
									'journal_voucher_amount'		=> $data['uniform_sales_price'],
									'journal_voucher_credit_amount'	=> $data['uniform_sales_price'],
									'account_id_status'				=> 1,
									'journal_voucher_item_token'	=> $data['uniform_sales_token'].$preferencecompany['account_uniform_sales_id'],
									'created_id' 					=> $auth['user_id'],
								);
								$this->AcctUniformSales_model->insertAcctJournalVoucherItem($data_credit);
							}else if($data['uniform_sales_payment_type'] == 2){
								// TODO : JOURNAL VOUCHER
								$account_id_default_status = $this->AcctUniformSales_model->getAccountIDDefaultStatus($preferencecompany['account_salary_payment_id']);
								$data_debet = array (
									'journal_voucher_id'			=> $journal_voucher_id,
									...
									'account_id_default_status'		=> $account_id_default_status,
									'account_id_status'				=> 0,
									'journal_voucher_item_token'	=> $data['uniform_sales_token'].$preferencecompany['account_salary_payment_id'],
									'created_id' 					=> $auth['user_id'],
								);
								$this->AcctUniformSales_model->insertAcctJournalVoucherItem($data_debet);
					...
					if($this->AcctSavingsAccount_model->insertAcctJournalVoucher($data_journal)){
						...
						if($data['uniform_sales_payment_type'] == 1){
							...
							$journal_voucher_item_token 		= $this->AcctUniformSales_model->getJournalVoucherItemToken($data_debet['journal_voucher_item_token']);
							...
							$journal_voucher_item_token 		= $this->AcctUniformSales_model->getJournalVoucherItemToken($data_credit['journal_voucher_item_token']);
