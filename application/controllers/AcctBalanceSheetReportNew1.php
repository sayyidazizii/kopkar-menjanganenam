...
<?php
	Class AcctBalanceSheetReportNew1 extends CI_Controller{
		...
		public function index(){
			...
			$data['main_view']['profitlossamount']				= $this->getProfitLossAmount();
			...
			if(!empty($acctbalancesheetreport_left && $acctbalancesheetreport_right)){
				...
				foreach($acctbalancesheetreport_left as $keyLeft =>$valLeft){
					if(is_numeric($keyLeft)){
						...
						if($valLeft['report_type1']	== 3){
							...
							$this->excel->getActiveSheet()->setCellValue('A'.$j, $valLeft['account_code1']);
							$this->excel->getActiveSheet()->setCellValue('B'.$j, $report_tab1.$valLeft['account_name1']);
							$this->excel->getActiveSheet()->setCellValue('C'.$j, $last_balance1);
						...
						if($valLeft['report_type1'] == 11){
							if(!empty($valLeft['report_formula1']) && !empty($valLeft['report_operator1'])){
								...
								$this->excel->getActiveSheet()->setCellValue('B'.$j, $report_tab1.$valLeft['account_name1']);
								$this->excel->getActiveSheet()->setCellValue('C'.$j, $total_account_amount10);
						...
						if($valLeft['report_type1'] == 5){
							if(!empty($valLeft['report_formula1']) && !empty($valLeft['report_operator1'])){
								...
								$this->excel->getActiveSheet()->setCellValue('B'.$j, $report_tab1.$valLeft['account_name1']);
								$this->excel->getActiveSheet()->setCellValue('C'.$j, ($total_account_amount1+$total_account_amount10));
				...
				foreach($acctbalancesheetreport_right as $keyRight =>$valRight){
					if(is_numeric($keyRight)){
						$this->excel->setActiveSheetIndex(0);
						$this->excel->getActiveSheet()->getStyle('E5'.':F'.($j+1))->getBorders()->getAllBorders()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
						$this->excel->getActiveSheet()->getStyle('B5'.':C'.($j+1))->getBorders()->getAllBorders()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
						...
						if($valRight['report_type2'] == 1){
							...
							$this->excel->getActiveSheet()->setCellValue('E'.$j, $valRight['account_name2']);
						} else {

						}

						if($valRight['report_type2']	== 2){
							$this->excel->getActiveSheet()->setCellValue('E'.$j, $report_tab2.$valRight['account_name2']);
						} else {
						...
						if($valRight['report_type2']	== 3){
							...
							$this->excel->getActiveSheet()->setCellValue('D'.$j, $valRight['account_code2']);
							$this->excel->getActiveSheet()->setCellValue('E'.$j, $report_tab2.$valRight['account_name2']);
							$this->excel->getActiveSheet()->setCellValue('F'.$j, $last_balance2);
						...
						if($valRight['report_type2'] == 11){
							if(!empty($valRight['report_formula2']) && !empty($valRight['report_operator2'])){
								...
								$this->excel->getActiveSheet()->setCellValue('E'.$j, $report_tab1.$valRight['account_name2']);
								$this->excel->getActiveSheet()->setCellValue('F'.$j, $total_account_amount210);
						...
						if($valRight['report_type2']	== 8){
							...
							$this->excel->getActiveSheet()->setCellValue('E'.$j, $report_tab2.$valRight['account_name2']);
							$this->excel->getActiveSheet()->setCellValue('F'.$j, $sahu_tahun_lalu);
						...
						if($valRight['report_type2']	== 7){
							...
							$this->excel->getActiveSheet()->setCellValue('E'.$j, $report_tab2.$valRight['account_name2']);
							$this->excel->getActiveSheet()->setCellValue('F'.$j, $profit_loss);
						...
						if($valRight['report_type2'] == 5){
							if(!empty($valRight['report_formula2']) && !empty($valRight['report_operator2'])){
								...
								$this->excel->getActiveSheet()->setCellValue('E'.$j, $report_tab2.$valRight['account_name2']);
								$this->excel->getActiveSheet()->setCellValue('F'.$j, $total_account_amount2+$total_account_amount210);
				...
				$this->excel->getActiveSheet()->getStyle('E'.$total_row_right)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
				$this->excel->getActiveSheet()->getStyle('F'.$total_row_right)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
				$this->excel->getActiveSheet()->getStyle("B".$total_row_left.":F".$total_row_right)->getFont()->setBold(true);	

				$this->excel->getActiveSheet()->setCellValue('B'.$total_row_left, $report_tab1.$valLeft['account_name1']);
				$this->excel->getActiveSheet()->setCellValue('C'.$total_row_left, $grand_total_account_amount1);
				$this->excel->getActiveSheet()->setCellValue('E'.$total_row_right, $valRight['account_name2']);
				$this->excel->getActiveSheet()->setCellValue('F'.$total_row_right, $grand_total_account_amount2);
		...
		public function getProfitLossAmount(){
			...
			if(!is_array($data)){
				...
				$data['profit_loss_report_type'] 	= 2;
