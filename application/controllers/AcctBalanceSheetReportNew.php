...
<?php
	Class AcctBalanceSheetReportNew extends CI_Controller{
		...
		public function index(){
			...
			$data['main_view']['content']						= 'AcctBalanceSheetReport/AcctBalanceSheetReportNew_view';
			        		...
			        		<table id=\"items\" width=\"100%\" cellspacing=\"1\" cellpadding=\"2\" border=\"0\">";	
			        			...
			        			foreach ($acctbalancesheetreport_left as $keyLeft => $valLeft) {
									...
									if($valLeft['report_type1']	== 3){
										$last_balance1 	= $this->AcctBalanceSheetReportNew_model->getLastBalance($valLeft['account_id1'], $sesi['branch_id'], $last_month, $last_year);		
			        		...
			        		<table id=\"items\" width=\"100%\" cellspacing=\"1\" cellpadding=\"2\" border=\"0\">";		
			        			...
			        			foreach ($acctbalancesheetreport_right as $keyRight => $valRight) {
									...
									if($valRight['report_type2']	== 3){
										$last_balance2 	= $this->AcctBalanceSheetReportNew_model->getLastBalance($valRight['account_id2'], $sesi['branch_id'], $last_month, $last_year);
