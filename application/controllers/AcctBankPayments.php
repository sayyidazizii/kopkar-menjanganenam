				...
				if($credits_payment_token->num_rows() == 0){
					if($this->AcctBankPayment_model->insert($data)){
						...
						if($data['credits_id'] != 99){
							...
							if($data['credits_interest_income']!='' && $data['credits_interest_income'] > 0){
								$account_id_default_status 			= $this->AcctCreditAccount_model->getAccountIDDefaultStatusMinimarket($preferencecompany['account_interest_income_id']);
							...
							if($data['credits_others_income']!='' && $data['credits_others_income'] > 0){
								$account_id_default_status 			= $this->AcctCreditAccount_model->getAccountIDDefaultStatusMinimarket($preferencecompany['account_others_income_id']);
							...
							$account_id_default_status 			= $this->AcctCreditAccount_model->getAccountIDDefaultStatusMinimarket($account_bank_id);
							...
							$account_id_default_status 			= $this->AcctCreditAccount_model->getAccountIDDefaultStatusMinimarket($preferencecompany['account_interest_id']);
							...
							if($data['credits_payment_fine'] > 0){
								$account_id_default_status 			= $this->AcctCreditAccount_model->getAccountIDDefaultStatusMinimarket($preferencecompany['account_credits_payment_fine']);
