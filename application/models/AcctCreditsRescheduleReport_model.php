<?php
	...
	class AcctCreditsRescheduleReport_model extends CI_Model {
		...
		public function getCreditsAccountReschedule($start_date, $end_date,$branch_id){
			$this->db->select('acct_credits_account_reschedule.credits_account_id, acct_credits_account.credits_account_serial, acct_credits_account.member_id, core_member.member_name, core_member.member_address, acct_credits_account_reschedule.credits_account_last_balance_old, acct_credits_account_reschedule.credits_account_interest_old, acct_credits_account_reschedule.credits_account_date_old, acct_credits_account_reschedule.credits_account_period_old, acct_credits_account_reschedule.credits_account_due_date_old, acct_credits_account_reschedule.credits_account_last_balance_new, acct_credits_account_reschedule.credits_account_interest_new, acct_credits_account_reschedule.credits_account_period_new, acct_credits_account_reschedule.credits_account_date_new, acct_credits_account_reschedule.credits_account_due_date_new');
