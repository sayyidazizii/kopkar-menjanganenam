<?php
	...
	class AcctUniformSales_model extends CI_Model {
		...
		public function getAcctUniformSales_Last($created_id){
			$this->db->select('acct_uniform_sales.uniform_sales_id, acct_uniform_sales.member_id, core_member.member_name, acct_uniform_sales.uniform_sales_no');
			$this->db->from('acct_uniform_sales');
			$this->db->join('core_member','acct_uniform_sales.member_id = core_member.member_id');
		...
		public function getJournalVoucherTokenMinimarket($journal_voucher_token){
			$this->dbminimarket->select('journal_voucher_token');
			$this->dbminimarket->from('acct_journal_voucher');
			$this->dbminimarket->where('journal_voucher_token', $journal_voucher_token);
			return $this->dbminimarket->get();
		}
		...
		public function getJournalVoucherItemTokenMinimarket($journal_voucher_item_token){
			$this->dbminimarket->select('journal_voucher_item_token');
			$this->dbminimarket->from('acct_journal_voucher_item');
			$this->dbminimarket->where('journal_voucher_item_token', $journal_voucher_item_token);
			return $this->dbminimarket->get();
		}
