<?php
	...
	class AcctSavingsProfitSharingReport_model extends CI_Model {
		...
		public function getAcctSavingsProfitSharing($period){
			$this->db->select('acct_savings_profit_sharing.savings_account_id, acct_savings_account.savings_account_no, acct_savings_profit_sharing.member_id, core_member.member_name, acct_savings_profit_sharing.savings_profit_sharing_amount, acct_savings_profit_sharing.savings_account_last_balance, acct_savings.savings_name');
			...
			$this->db->join('acct_savings', 'acct_savings.savings_id = acct_savings_profit_sharing.savings_id');
