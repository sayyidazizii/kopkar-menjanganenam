<?php
	...
	class AcctCreditsPaymentSuspend_model extends CI_Model {
		var $table = "acct_credits_payment_suspend";
		var $column_order = array(null, 'acct_credits_account.credits_account_serial','core_member.member_name','acct_credits_payment_suspend.credits_payment_suspend_date',); //field yang ada di table user
		var $column_search = array('acct_credits_account.credits_account_serial','core_member.member_name','acct_credits_payment_suspend.credits_payment_suspend_date'); //field yang diizin untuk pencarian 
		var $order = array('acct_credits_payment_suspend.credits_payment_suspend_id' => 'asc');
	    ...
	    public function count_all($start_date, $end_date, $credits_id, $branch_id)
	    {
			...
			$this->db->where('acct_credits_payment_suspend.credits_payment_suspend_date >=', $start_date);
			$this->db->where('acct_credits_payment_suspend.credits_payment_suspend_date <=', $end_date);
		...
		public function insert($data){
			return $query = $this->db->insert('acct_credits_payment_suspend',$data);
		}
		...
		public function AcctCreditsPaymentSuspendLast($created_id){
