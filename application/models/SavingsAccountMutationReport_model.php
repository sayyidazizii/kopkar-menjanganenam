<?php
	...
	class SavingsAccountMutationReport_model extends CI_Model {
		...
		public function getSavingsAccountMutationReport($start_date, $end_date, $savings_id){
			$this->db->select('acct_savings_account_detail.savings_account_detail_id, acct_savings_account_detail.savings_account_id, acct_savings_account.savings_account_no, acct_savings_account_detail.member_id, core_member.member_no, core_member.member_name, core_member.member_address, acct_savings_account_detail.mutation_id, acct_mutation.mutation_status, acct_mutation.mutation_code, acct_savings_account_detail.mutation_in, acct_savings_account_detail.mutation_out, acct_savings_account_detail.opening_balance, acct_savings_account_detail.last_balance, acct_savings_account_detail.savings_id, acct_savings.savings_name, acct_savings_account_detail.today_transaction_date, acct_savings_account_detail.created_id, acct_savings_account_detail.description, acct_savings_account_detail.operated_name, acct_mutation.mutation_name, core_division.division_name');
			...
			$this->db->join('core_member_working', 'acct_savings_account_detail.member_id = core_member_working.member_id');
