<?php
	...
	class AcctSavingsImportMutation_model extends CI_Model {
		...
		public function getAcctSavingsCashMutationImport(){
		...
		public function getAcctSavingsImportMutation(){
			$this->db->select('*');
			$this->db->from('acct_savings_import_mutation');
			$result = $this->db->get()->result_array();
			return $result;
		}
		...
		public function insertAcctSavingsImportMutation($data){
			$query = $this->db->insert('acct_savings_import_mutation',$data);
			if($query){
				return true;
			}else{
				return false;
		...
		public function truncateAcctSavingsImportMutation(){
			$query = $this->db->truncate('acct_savings_import_mutation');
			if($query){
				return true;
			}else{
				return false;
