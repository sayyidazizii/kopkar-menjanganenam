<?php
	class AcctJournalPPOB_model extends CI_Model {
		...
		public function getAcctJournalPPOB($start_date, $end_date, $branch_id){
			...
			$this->db->like('acct_journal_voucher.transaction_module_code', 'PPOB');	
