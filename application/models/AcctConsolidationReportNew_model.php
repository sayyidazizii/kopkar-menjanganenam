<?php
	...
	class AcctConsolidationReportNew_model extends CI_Model {
		...
		// public function getPembagianSHUTahunLalu($branch_id, $month, $year){
		...
		// 	$this->db->where('acct_profit_loss_allocation.month_period >=', $month);
		// 	$this->db->where('acct_profit_loss_allocation.year_period >=', $year);
		// 	$this->db->limit(1);
		// 	$result = $this->db->get()->row_array();
