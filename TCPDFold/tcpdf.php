...
class TCPDF {
	...
	public function __construct($orientation='P', $unit='mm', $format='A4', $unicode=true, $encoding='UTF-8', $diskcache=false, $pdfa=false) {
		...
		$this->setSubHeaderFont(array($this->FontFamily, $this->FontStyle, $this->FontSizePt));
	 ...
	 * @public
	 */
	public function setHeaderData($ln='', $lw=0, $ht='', $tc=array(0,0,0), $lc=array(255,255,255)) {
		$this->header_logo = $ln;
	...
	public function setSubHeaderData($ln='', $lw=0, $hs='', $tc=array(0,0,0), $lc=array(0,0,0)) {
		$this->header_logo = $ln;
		$this->header_logo_width = $lw;
	...
	public function getSubHeaderData() {
		$ret = array();
	...
	protected function setSubHeader() {
		if (!$this->print_header OR ($this->state != 2)) {
			return;
		}
		$this->InHeader = true;
	...
	public function setSubHeaderFont($font) {
	...
	public function getSubHeaderFont() {
		return $this->subheader_font;
	}
